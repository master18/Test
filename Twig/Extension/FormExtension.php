...
namespace px\FormBundle\Twig\Extension;
...
class FormExtension extends \Twig_Extension
{
    ...
    public function getFunctions()
    {
        return array(
            ...
            'form_pdf' => new \Twig_Function_Method($this, 'renderPdf', array('is_safe' => array('html'),'needs_environment' => true)),
     ...
     * @return string
     */
    public function renderPdf(\Twig_Environment $twig,$host,$path,$height=1000)
    {
        return $twig->render('pxFormBundle:Form:pdf.html.twig',array('host'=>$host,'path'=>$path,'height'=>$height));
    }
    /**
     * {@inheritdoc}
     */
